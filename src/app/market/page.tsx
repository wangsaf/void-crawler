          ...
          {checkoutPuzzle.active && (
            ...
            >
              <motion.div
                ...
                animate={{ scale: 1, y: 0 }}
                exit={{ scale: 0.7, y: 50 }}
                className="glass-strong mx-4 w-full max-w-md rounded-xl border border-white/10 p-5 box-glow-purple"
              >
          ...
          {taxGoblin.active && (
            ...
            >
              <motion.div
                ...
                className="glass-strong mx-4 w-full max-w-md rounded-xl border border-white/10 p-5"
              >
                <motion.div
